			...
			<div class="container">
				<div class="row fullscreen justify-content-center align-items-center">
					<div class="col-lg-8">
                        ...
                        <div class="wrapper">
                            <h2 class="text-uppercase text-white">PROCTOR</h2>
                            <p class="text-white">Please fill in your credentials to login.</p>
                            <form action="<?php echo htmlspecialchars($_SERVER[" PHP_SELF "]); ?>" method="post">
                                <div class="form-group <?php echo (!empty($username_err)) ? 'has-error' : ''; ?>">
                                    <label class="text-uppercase text-white">Username</label>
                                    <input type="text" name="username" class="form-control" value="<?php echo $username; ?>">
                                    <span class="help-block"><?php echo $username_err; ?></span>
                                </div>
                                <div class="form-group <?php echo (!empty($password_err)) ? 'has-error' : ''; ?>">
                                    <label class="text-uppercase text-white">Password</label>
                                ...
                                <p class="text-uppercase text-white">Don't have an account? <a href="register.php" class="text-uppercase text-white">Sign up now</a>.</p>
                            </form>
                        </div>
						</div>
					</div>
