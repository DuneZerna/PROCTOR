                ...
                <div class="row fullscreen justify-content-center align-items-center">
                    <div class="col-lg-8">
                        <div class="banner-content text-center">
                            ...
                            <!-- <h1 class="text-uppercase text-white">DESIGNING IMMENSIVE SOLUTIONS</h1> -->
                            <div class="page-header">
                                <h1 class="text-uppercase text-white">Hi, <b><?php echo htmlspecialchars($_SESSION["username"]); ?></b>. Welcome to our site.</h1>
                            </div>
                            <p>
                                <a href="reset-password.php" class="btn btn-warning">Reset Your Password</a>
                                <a href="logout.php" class="btn btn-danger">Sign Out of Your Account</a>
                                <p class="text-uppercase text-white">You are about to get redirected, if not, please button below</p>
                                <p><a class="text-uppercase text-white" href="http://proctor.le-techdesign.net/index.html">Redirect</a></p>
                            </p>
                        </div>
                    </div>
                </div>
